...
from app.models.media_processing.internal import ImageProcessingResult
...
def chunk_and_store(result: ImageProcessingResult, media_id: str | None = None) -> Generator[str, None, None]:
    yield "CHUNKING"
...
def _build_chunks(result: ImageProcessingResult, media_id: str | None = None) -> list[Document]:
    metadata = {"source": result.original_filename}
